        ...
        <>
            <nav className="flex items-center bg-white max-h-20">
                <div className="grow-0.5 mb-5 mt-5">
                    <img className="h-20 w-20 rounded-full " src={"https://thumbs.dreamstime.com/b/lets-shopping-logo-design-template-shop-icon-135610500.jpg"}/>
                </div>//todo icon
                <div className="grow-1 justify-between space-x-2 flex">
                    ...
                    <div className="flex items-center justify-center w-full ml-10">
                        <img src={"https://i.pinimg.com/236x/15/0f/a8/150fa8800b0a0d5633abc1d1c4db3d87.jpg?nii=t"} alt={"no pfp"}
                        ...
                        <button className="container border border-red-400 bg-emerald-300 m-5 rounded-2xl">Register</button>
                    </div>
