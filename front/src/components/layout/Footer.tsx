const Footer = () => {
    return (
        <>
            ...
            <div className='bg-white pt-20 px-4 mt-1'>
                <footer
                    className="bg-white w-full max-w-[1350px] mx-auto text-black pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            ...
                            <p className="text-sm/6 text-neutral-600 max-w-96">PrebuiltUI helps you build faster by
                                transforming your design vision into fully functional, production-ready UI
                                components.</p>
                        ...
                        <div
                            className="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 lg:gap-28 items-start">
                            {/* Products */}
                            <div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 text-sm text-neutral-800">
                                    <li><a href="#" className="hover:text-neutral-700">PrebuiltUI</a></li>
                                    <li><a href="#" className="hover:text-neutral-700">Templates</a></li>
                                    <li><a href="#" className="hover:text-neutral-700">Components</a></li>
                            ...
                            <div className="col-span-2 md:col-span-1">
                                ...
                                <ul className="space-y-3 text-sm text-neutral-800">
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        <span
                                            className="text-[11px] px-2 py-0.5 rounded-full bg-neutral-50 border border-neutral-400 text-neutral-700">HIRING</span>
                                    </li>
                    ...
                    <div className="relative">
                        <div
                            className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-3xl h-full max-h-64 bg-slate-100 rounded-full blur-[100px] pointer-events-none"/>
                    </div>
                </footer>
            </div>
        </>
